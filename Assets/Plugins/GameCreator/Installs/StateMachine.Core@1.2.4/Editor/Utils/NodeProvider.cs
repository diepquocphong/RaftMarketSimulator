...
namespace NinjutsuGames.StateMachine.Editor
{
    public static class NodeProvider
    {
        ...
        private static Dictionary<Type, MonoScript> nodeViewScripts = new Dictionary<Type, MonoScript>();
        private static Dictionary<Type, MonoScript> nodeScripts = new Dictionary<Type, MonoScript>();
        private static Dictionary<Type, Type> nodeViewPerType = new Dictionary<Type, Type>();
        ...
        private static Dictionary<StateMachineAsset, NodeDescriptions> specificNodeDescriptions = new Dictionary<StateMachineAsset, NodeDescriptions>();
        private static List<NodeSpecificToGraph> specificNodes = new List<NodeSpecificToGraph>();

        private static NodeDescriptions genericNodes = new NodeDescriptions();
