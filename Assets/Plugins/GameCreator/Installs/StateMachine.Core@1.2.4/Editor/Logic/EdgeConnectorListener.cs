...
namespace NinjutsuGames.StateMachine.Editor
{
    ...
    public class BaseEdgeConnectorListener : IEdgeConnectorListener
    {
        ...
        private Dictionary<Edge, PortView> edgeInputPorts = new Dictionary<Edge, PortView>();
        private Dictionary<Edge, PortView> edgeOutputPorts = new Dictionary<Edge, PortView>();
        ...
        private void ShowNodeCreationMenuFromEdge(EdgeView edgeView, Vector2 position)
        {
            ...
            /*MouseUpEvent evt = MouseUpEvent.GetPooled(position, 0, 1, position);
            graphView.panel.contextualMenuManager.DisplayMenu(evt, graphView);
