...
namespace NinjutsuGames.StateMachine.Editor
{
    public class ToolbarView : VisualElement
    {
        ...
        protected virtual void AddButtons()
        {
            ...
            var blackboardVisible = graphView.GetPinnedElementStatus<BlackboardView>() != DropdownMenuAction.Status.Hidden;
            showParameters = AddToggle("Blackboard", blackboardVisible, v => graphView.ToggleView<BlackboardView>());
