...
namespace NinjutsuGames.StateMachine.Editor
{
    ...
    {
        private StateMachineAsset graph;
        [SerializeField] private ExposedParameterWorkaround exposedParameterObject;
        private SerializedObject serializedObject;
        private SerializedProperty serializedParameters;

        private Dictionary<ExposedParameter, object> oldParameterValues = new Dictionary<ExposedParameter, object>();
        private Dictionary<ExposedParameter, ExposedParameter.Settings> oldParameterSettings = new Dictionary<ExposedParameter, ExposedParameter.Settings>();

        public ExposedParameterFieldFactory(StateMachineAsset graph, List<ExposedParameter> customParameters = null)
        {
            this.graph = graph;
