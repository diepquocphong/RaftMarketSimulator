...
namespace NinjutsuGames.StateMachine.Editor
{
    ...
    public class BaseNodeView : NodeView
    {
        ...
        public void Initialize(BaseGraphView owner, BaseNode node)
        {
            ...
            ((BaseGameCreatorNode) node).onExecutionDisabled += UpdateExecutionStateView;
            ((BaseGameCreatorNode) node).onExecutionEnabled += UpdateExecutionStateView;
        ...
        public void ToggleExecutionState()
        {
            ...
            if(nodeTarget.enabledForExecution) gcNode.Enable(context);
            else gcNode.Disable(context);
        ...
        protected void UpdateExecutionStateView()
        {
            if (Application.isPlaying)
            {
                ...
                mainContainer.SetEnabled(nodeTarget.CanExecute(context));
            }
            else mainContainer.SetEnabled(nodeTarget.enabledForExecution);
            owner.RefreshNodeInspector();
        }
