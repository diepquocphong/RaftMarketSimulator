...
namespace XFrameEffect {
    ...
    public class XFrameManager : MonoBehaviour {
        ...
        [SerializeField]
        int
                        _targetFPSforStaticCamera = 30;

        public int targetFPSforStaticCamera {
            get { return _targetFPSforStaticCamera; }
            set {
                if (_targetFPSforStaticCamera != value) {
                    _targetFPSforStaticCamera = Mathf.Clamp(value, 10, 120);
                    UpdateSettings();
                    isDirty = true;
                }
            }
        ...
        public bool niceFPSisActive { get { return avgFPSNice >= _niceFPS && _niceFPSEnabled && _method == XFRAME_DOWNSAMPLING_METHOD.AdaptativeDownsampling && _compositingMethod != XFRAME_COMPOSITING_METHOD.UniversalRenderingPipeline; } }
        ...
        public float downsamplingMax {
            get { return _downsamplingMax; }
            set {
                if (_downsamplingMax != value) {
                    _downsamplingMax = rtClamp(value);
                    isDirty = true;
                }
            }
        }
        ...
        [SerializeField]
        float
                        _downsamplingStart = 1f;

        public float downsamplingStart {
            get { return _downsamplingStart; }
            set {
                if (_downsamplingStart != value) {
                    _downsamplingStart = rtClamp(value);
                    isDirty = true;
                }
            }
        }
        ...
        public bool blendWithBackground {
            get { return _blendWithBackground; }
            set {
                if (_blendWithBackground != value) {
                    _blendWithBackground = value;
                    CheckCamera();
                    isDirty = true;
                }
            }
        ...
        public bool reducePixelLights {
            ...
            set {
                if (_reducePixelLights != value) {
                    ...
                    if (Application.isPlaying && !_reducePixelLights && oldPixelLightCount > 0) {
                        if (maxAdditionalLightsCountProp != null) {
                            maxAdditionalLightsCountProp.SetValue(pipelineAsset, oldPixelLightCount, null);
                        } else {
        ...
        float _reducePixelLightsThreshold = 0.7f;
        public float reducePixelLightsThreshold {
            get { return _reducePixelLightsThreshold; }
            set {
                if (_reducePixelLightsThreshold != value) {
                    _reducePixelLightsThreshold = value;
                    isDirty = true;
                }
            }
        }
        ...
        public bool manageLODBias {
            get { return _manageLODBias; }
            set {
                if (_manageLODBias != value) {
                    _manageLODBias = value;
                    if (Application.isPlaying && !_manageLODBias && oldLODBias > 0) {
        ...
        [SerializeField]
        float
                        _lodBiasMinimum = 0.2f;

        public float lodBiasMinimum {
            get { return _lodBiasMinimum; }
            set {
                if (_lodBiasMinimum != value) {
                    _lodBiasMinimum = value;
                    isDirty = true;
                }
            }
        }
        ...
        public float lodBiasMaximum {
            get { return _lodBiasMaximum; }
            set {
                if (_lodBiasMaximum != value) {
                    _lodBiasMaximum = value;
                    _lodBiasMaximum = Mathf.Max(_lodBiasMinimum, _lodBiasMaximum);
                    isDirty = true;
                }
            }
        }
        ...
        [SerializeField]
        float
                        _staticCameraPositionThreshold = 0.01f;

        public float staticCameraPositionThreshold {
            get { return _staticCameraPositionThreshold; }
            set {
                if (_staticCameraPositionThreshold != value) {
                    _staticCameraPositionThreshold = value;
                    isDirty = true;
                }
            }
        }
        ...
        [SerializeField]
        float
                _manageShadowsMinDistance;

        public float manageShadowsMinDistance {
            get { return _manageShadowsMinDistance; }
            set {
                if (_manageShadowsMinDistance != value) {
                    _manageShadowsMinDistance = value;
                    isDirty = true;
                }
            }
        }
        ...
        [SerializeField]
        float
                        _manageShadowsMinInterval = 5f;

        public float manageShadowsMinInterval {
            get { return _manageShadowsMinInterval; }
            set {
                if (_manageShadowsMinInterval != value) {
                    _manageShadowsMinInterval = value;
                    isDirty = true;
                }
            }
        }
        ...
        public int activeTargetFPS {
            get {
                return cameraIsStatic ? _targetFPSforStaticCamera : _targetFPS;
            }
        }
        ...
        int oldVSyncCount, oldTargetFrameRate;
        float oldShadowsDistance;
        bool cameraIsStatic;
        Vector3 oldCameraPos, oldCameraRot;
        int oldPixelLightCount;
        List<Light> lights;
        float lastLightCheckTime, lastShadowsDisableTime;
        ...
        PropertyInfo renderScaleProp, shadowDistanceProp, maxAdditionalLightsCountProp;
        ...
        private void OnValidate() {
            _staticCameraPositionThreshold = Mathf.Max(0, _staticCameraPositionThreshold);
        }

        void Start() {
            nextPeriod = Time.realtimeSinceStartup + FPS_UPDATE_RATE;
            if (maxAdditionalLightsCountProp != null) {
                oldPixelLightCount = (int)maxAdditionalLightsCountProp.GetValue(pipelineAsset, null);
            } else {
            ...
            if (shadowDistanceProp != null) {
                oldShadowsDistance = (float)shadowDistanceProp.GetValue(pipelineAsset, null);
            } else {
                oldShadowsDistance = QualitySettings.shadowDistance;
            }
        ...
        void Init() {
            ...
            fps = activeTargetFPS;
            avgDownsampling = _downsamplingStart;
            ClearRTArray();
        ...
        void CheckPipeline() {
            ...
            renderScaleProp = null;
            shadowDistanceProp = null;
            if (pipelineAsset != null) {
                renderScaleProp = pipelineAsset.GetType().GetProperty("renderScale");
                if (renderScaleProp == null) {
                    renderScaleProp = pipelineAsset.GetType().GetProperty("RenderScale");
                }
                shadowDistanceProp = pipelineAsset.GetType().GetProperty("shadowDistance");
                if (shadowDistanceProp == null) {
                    shadowDistanceProp = pipelineAsset.GetType().GetProperty("ShadowDistance");
                }
                maxAdditionalLightsCountProp = pipelineAsset.GetType().GetProperty("maxAdditionalLightsCount");
                if (maxAdditionalLightsCountProp == null) {
                    maxAdditionalLightsCountProp = pipelineAsset.GetType().GetProperty("MaxAdditionalLightsCount");
                }
                if (renderScaleProp != null) {
                    _compositingMethod = XFRAME_COMPOSITING_METHOD.UniversalRenderingPipeline;
                    if (shadowDistanceProp != null) {
                        oldShadowsDistance = (float)shadowDistanceProp.GetValue(pipelineAsset, null);
                    }
                    if (mainCamera != null) {
            ...
            if (_compositingMethod == XFRAME_COMPOSITING_METHOD.UniversalRenderingPipeline) {
                Debug.LogWarning("Universal Rendering Pipeline is not enabled in Graphics or Quality Settings. Reverting to Second Camera Billboard mode.");
                _compositingMethod = XFRAME_COMPOSITING_METHOD.SecondCameraBillboardWorldSpace;
            }
        }
        ...
        void LateUpdate() {
            ...
            if (_compositingMethod != XFRAME_COMPOSITING_METHOD.UniversalRenderingPipeline) {
                if (_niceFPSEnabled && Application.isPlaying && _method == XFRAME_DOWNSAMPLING_METHOD.AdaptativeDownsampling) {
            ...
            if (camMovDetectThreshold++ > 5) {
                ...
                float cameraDistance = Vector3.SqrMagnitude(mainCamera.transform.position - oldCameraPos);
                if (cameraDistance >= _staticCameraPositionThreshold * _staticCameraPositionThreshold || camRot != oldCameraRot) {
                    cameraIsStatic = false;
            ...
            if (Time.time > nextPeriod) {
                ...
                if (_method == XFRAME_DOWNSAMPLING_METHOD.Disabled) {
                    ...
                    if (fps >= activeTargetFPS) {
                        avgDownsampling += Mathf.Min(_fpsChangeSpeedUp * (fps - activeTargetFPS), _fpsChangeSpeedUp);
                    } else {
                        avgDownsampling -= Mathf.Min(_fpsChangeSpeedDown * (activeTargetFPS - fps), _fpsChangeSpeedDown);
                    }
                ...
                if (_manageLODBias) {
                    float newLODbias = avgDownsampling < 1f ? Mathf.Lerp(_lodBiasMinimum, _lodBiasMaximum, avgDownsampling) : oldLODBias;
                    if (QualitySettings.lodBias != newLODbias) {
        ...
        void CheckCamera() {
            ...
            if ((_method == XFRAME_DOWNSAMPLING_METHOD.Disabled || _compositingMethod == XFRAME_COMPOSITING_METHOD.UniversalRenderingPipeline) && xFrameCameraObj != null) {
                DestroyXFrameCamera();
            }

            if (_method == XFRAME_DOWNSAMPLING_METHOD.Disabled || _compositingMethod == XFRAME_COMPOSITING_METHOD.UniversalRenderingPipeline)
                return;
        ...
        void SetupSecondCameraBlitMode() {
            ...
            if (xFramePost == null) {
                xFramePost = xFrameCameraObj.gameObject.AddComponent<PostFrameCompositor>();
            }
            xFramePost.xFrameManager = this;
        }
        ...
        void SetupSecondCameraBillboardWorldSpaceMode() {
            ...
            if (_blendWithBackground) {
                if (_cameraClearFlags == CameraClearFlags.Color || _cameraClearFlags == CameraClearFlags.Skybox) {
            ...
            if (mainCamera != null) {
                xFrameCamera.CopyFrom(mainCamera);
                mainCamera.transform.localScale = Vector3.one; // in case main camera has a strange scale applied to it
                //xFrameCamera.depth++;
            }
            ...
            if (_blendWithBackground) {
                xFrameBillboardMat.SetInt("_BlendSrc", (int)BlendMode.SrcAlpha);
                xFrameBillboardMat.SetInt("_BlendDst", (int)BlendMode.OneMinusSrcAlpha);
            } else {
                xFrameBillboardMat.SetInt("_BlendSrc", (int)BlendMode.One);
                xFrameBillboardMat.SetInt("_BlendDst", (int)BlendMode.Zero);
            }
        ...
        void UpdateBillboardAspectRatio(float aspect) {
            if (xFrameBillboardObj != null) {
                xFrameBillboardObj.transform.localScale = new Vector3(aspect, 1f, 1f);
                if (xFrameCamera != null) {
                    xFrameCamera.aspect = aspect;
                }
            }
        }
            ...
            if (_compositingMethod == XFRAME_COMPOSITING_METHOD.UniversalRenderingPipeline) {
                ...
                if (renderScaleProp != null) {
                    if (Mathf.Abs(avgDownsampling - rtDownsampling) < 0.05f)
                        return;
                    rtDownsampling = Mathf.Min(avgDownsampling, _downsamplingMax);
                    renderScaleProp.SetValue(pipelineAsset, rtDownsampling, null);
                }
                return;
            }
                ...
                case XFRAME_DOWNSAMPLING_METHOD.HorizontalDownsampling:
                    ...
                    if (rt != null) {
                        ...
                        if (aspectRatio != mainCamera.aspect) {
                            ...
                            UpdateBillboardAspectRatio(aspectRatio);
                        }
                    }
                    break;
                case XFRAME_DOWNSAMPLING_METHOD.QuadDownsampling:
        ...
        void ResetCameraAspect() {
            ...
            if (mainCamera.aspect != aspect) {
                ...
                UpdateBillboardAspectRatio(aspect);
            }
        }


        /// <summary>
        /// Finds and make all canvas objects to work properly with X-Frame
        /// </summary>
        public void UpdateUICanvases() {
            ...
            for (int k = 0; k < canvases.Length; k++) {
                ...
                UpdateUICanvas(canvas);
            }
        }


        /// <summary>
        /// Updates a single canvas to work properly with X-Frame
        /// </summary>
        public void UpdateUICanvas(Canvas canvas) {
            ...
            if (canvas.worldCamera == mainCamera || canvas.worldCamera == null || canvas.renderMode == RenderMode.ScreenSpaceOverlay) {
                GraphicRaycaster rc = canvas.GetComponent<GraphicRaycaster>();
                if (rc == null) return;
        ...
        /// <summary>
        /// Restores al canvases to default settings
        /// </summary>
        public void RestoreUICanvases() {
            if (canvases == null) return;
            for (int k = 0; k < canvases.Length; k++) {
                Canvas canvas = canvases[k];
                RestoreUICanvas(canvas);
            }
        }

        /// <summary>
        /// Restores a single UI Canvas to default behaviour
        /// </summary>
        ...
        void ResetShadows() {
            ...
            if (_compositingMethod == XFRAME_COMPOSITING_METHOD.UniversalRenderingPipeline) {
                if (shadowDistanceProp != null) {
                    shadowDistanceProp.SetValue(pipelineAsset, oldShadowsDistance, null);
                }
            } else {
                if (QualitySettings.shadowDistance != oldShadowsDistance) {
        ...
        void ManagePixelLights() {
            if (maxAdditionalLightsCountProp != null) {
                int maxAdditionalLightCount = avgDownsampling < _reducePixelLightsThreshold ? 0 : oldPixelLightCount;
                maxAdditionalLightsCountProp.SetValue(pipelineAsset, maxAdditionalLightCount, null);
            } else {
                int newPixelLightCount = avgDownsampling < _reducePixelLightsThreshold ? 1 : oldPixelLightCount;
        ...
        void ManageShadows() {
            ...
            // Adjust shadows distance
            if (_manageShadowsMinDistance < oldShadowsDistance) {
                float minDistance = Mathf.Lerp(_manageShadowsMinDistance, oldShadowsDistance, avgDownsampling);
                if (shadowDistanceProp != null) {
                    shadowDistanceProp.SetValue(pipelineAsset, minDistance, null);
                } else {
                    if (QualitySettings.shadowDistance != minDistance) {
                        QualitySettings.shadowDistance = minDistance;
                    }
                }
            }

            // Find lights with shadows and manage their quality settings
            float now = Time.time;
            if (lights == null || now - lastLightCheckTime > 10f) {
            ...
            if (avgDownsampling >= 1f) {
                if (now > lastShadowsDisableTime + _manageShadowsMinInterval) {
                    lastShadowsDisableTime = now;
                    for (int k = 0; k < lightsCount; k++) {
                        Light light = lights[k];
                        if (light == null)
                            continue;
                ...
                if (pendingHardShadows && manageShadowsMinDistance <= 0 && avgDownsampling <= activeDownsampling) {
                    for (int k = 0; k < lightsCount; k++) {
                        Light light = lights[k];
                        if (light == null)
                            continue;
        ...
        public Vector3 AdjustScreenPosition(Vector3 position, bool targetIsDownscaled = true) {
            ...
            if (targetIsDownscaled) {
                ...
                position.x *= (float)screenWidth / rt.width;

                if (_method != XFRAME_DOWNSAMPLING_METHOD.HorizontalDownsampling) {
                    position.y *= (float)screenHeight / rt.height;
                }
            }
